						...
						client.get(CaptureService.URL_BASE + "register", params,  new JsonHttpResponseHandler() {
							...
							public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
						    	...
						    	try {
						    		...
						    		Toast.makeText(RegisterActivity.this, "Telefono Registrado.", Toast.LENGTH_SHORT).show();
						    		...
						    		Toast.makeText(RegisterActivity.this, "Registro desabilitado, verifique su conexiin a internet.", Toast.LENGTH_SHORT).show();
						    	}
						    }
