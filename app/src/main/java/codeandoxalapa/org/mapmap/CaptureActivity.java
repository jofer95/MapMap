...
public class CaptureActivity extends Activity implements ICaptureActivity {
    ...
    public void subirCapturaVoolley(RouteCapture rutaCapturada) {
        final Context context = CaptureActivity.this;
        try {
            ...
            String url = CaptureService.URL_BASE3 + "guardarDatosMap";
            ...
            JsonObjectRequest jsonOblect = new JsonObjectRequest(Request.Method.POST, url, jsonBody, new Response.Listener<JSONObject>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(context,"Error al sincronizar datos",Toast.LENGTH_LONG).show();
                }
            }) {
                @Override
